...
import { Framebuffer, Viewer, ViewType } from '@xbim/viewer';
    ...
    */
    ...
    public init(viewer: Viewer) {
        ...
        viewer.on('pick', (args) => {
            ...
            let idArg: MouseEvent | Touch|null = null;
    ...
    private draw(viewerWidth: number, viewerHeight: number) {
        ...
        let [x,y,z,sizeX,sizeY,sizeH]=this.selectedBox;
        ...
        let rotation = mat3.fromMat4(mat3.create(),this.viewer.mvMatrix);
        ...
        // mat4.translate(pMatrix,pMatrix, vec3.fromValues(x,y,z)); //far
